...
async function loginQueryForLinked(data: LoginType, router: any) {
  ...
  fetch('http://localhost:3030/search/auth',{method: 'POST', body: formData, headers: {'Content-Type': 'application/x-www-form-urlencoded'}}).then(response => {
    if (!response.ok) {
        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <ToggleButtonGroup
              ...
              disabled={loading}
            >
              <ToggleButton value="insta" aria-label="left aligned" color='success'>
                <Image src='/insta.png' width={32} height={32} alt='insta'/>
              </ToggleButton>
              <ToggleButton value="linked" aria-label="right aligned" color='primary'>
